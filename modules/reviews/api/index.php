...
require_once __DIR__ . '/../controllers/review-controller.php';
...
switch ($method) {
    case 'GET':
        // Reviews might be publicly readable, but for consistency with other modules, require login for now
        AuthMiddleware::requireLogin(); 
        AuthMiddleware::requirePermission('reviews:read'); // Specific permission for reading reviews
        break;
    case 'POST':
        AuthMiddleware::requirePermission('reviews:manage'); // Creating reviews requires specific permission
        break;
    case 'PUT':
        AuthMiddleware::requirePermission('reviews:manage'); // Updating reviews requires specific permission
        break;
    case 'DELETE':
        AuthMiddleware::requirePermission('reviews:manage'); // Deleting reviews requires specific permission
        break;
    case 'OPTIONS':
