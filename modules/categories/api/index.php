...
switch ($method) {
    ...
    case 'POST':
        ...
        break;
    case 'PUT':
        AuthMiddleware::requirePermission('categories:manage'); // Updating categories requires specific permission
        break;
    case 'DELETE':
        AuthMiddleware::requirePermission('categories:manage'); // Deleting categories requires specific permission
        break;
    case 'OPTIONS':
