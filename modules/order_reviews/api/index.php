...
require_once __DIR__ . '/../controllers/order_review-controller.php';
...
switch ($method) {
    case 'GET':
        ...
        AuthMiddleware::requirePermission('order_reviews:read'); // Specific permission for reading order reviews
        break;
    case 'POST':
        AuthMiddleware::requireLogin(); 
        AuthMiddleware::requirePermission('order_reviews:manage'); // Creating order reviews requires specific permission
        break;
    case 'PUT':
        AuthMiddleware::requireLogin(); 
        AuthMiddleware::requirePermission('order_reviews:manage'); // Updating order reviews requires specific permission
        break;
    case 'DELETE':
        AuthMiddleware::requireLogin(); 
        AuthMiddleware::requirePermission('order_reviews:manage'); // Deleting order reviews requires specific permission
        break;
    case 'OPTIONS':
